    ...
    function throttle(func, wait, options) {
        ...
        function _renderfl(bridge) {
            ...
            for (var i = 0; i < items.length; i++) {
                if (!items[i].getAttribute("fqbItemId")&&(items[i].offsetParent.offsetTop+items[i].offsetHeight>scrollTop)&&(items[i].offsetParent.offsetTop+items[i].offsetHeight<innerHeight+scrollTop)) {
